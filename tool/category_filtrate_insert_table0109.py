...
def Get_Categroy_Data():
    ...
    select_sql = '''SELECT id FROM taobao_item_product_delete_state0115;'''
...
def Insert_Data(cat_ids):
    ...
    for cat_id in cat_ids:
        ...
        print(cat_id)
        # 两个表都要改，以免出错
        # select_sql = '''INSERT IGNORE INTO taobao_list_web_2020_0110 SELECT * FROM taobao_list_web_1230_copy2 WHERE category=%s;'''
...
def teshu_insert_data():
    ...
    #     print(keyword)
        ...
        # 两个表都要改，以免出错
    select_sql = '''INSERT IGNORE INTO taobao_list_web_2020_0110 SELECT * FROM taobao_list_web_1230_copy2 WHERE
     category=%s AND title LIKE '%%止汗露%%';'''
