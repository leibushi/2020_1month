...
def Get_Categroy_Data(limit):
    ...
    # 全部品类
    select_sql = '''SELECT cat_id FROM taobao_category_20200202 WHERE is_del IS NULL AND cat_id != '216505' AND cat_id != '127848002';'''
    # 317 不包括 两个特殊品类
    # select_sql = '''SELECT cat_id FROM taobao_category WHERE is_del IS NULL AND cat_id != '216505' AND cat_id != '127848002';'''
    # 311 个 品类不包括两个特殊品类
    # select_sql = '''SELECT cat_id FROM taobao_category_20200102 WHERE is_del IS NULL limit 0, {};'''.format(limit)
...
def Insert_Data(cat_ids):
    ...
    for cat_id in cat_ids:
        ...
        print(cat_id)
        # 两个表都要改，以免出错
        # select_sql = '''INSERT IGNORE INTO taobao_list_web_2020_0113_copy1_copy1 SELECT * FROM taobao_list_web_2020_0113_copy1 WHERE category_id=%s;'''
        select_sql = '''INSERT IGNORE INTO taobao_list_web_2020_0113_copy1_copy1 SELECT * FROM taobao_list_web_2020_0113_copy1 WHERE category=%s;'''
...
def main():
    # insert_datas()
    # 处理筛选品类
    cat_data = Get_Categroy_Data(500)
